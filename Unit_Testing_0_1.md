...
- على عكس اختبار اتمتة الوحدة يسمح للمختبر ان يقوم باتخاذ قارارات سريعة وبديهية اثناء عملية الاختبار
...
على الرغم من أن وجود أداة تعمل بدون تدخل بشري يبدو جذاباً، إلا أن هناك بعض العيوب المهمة:

- **تكلفة الإعداد الأولية**: كتابة اختبارات وحدات آلية تتطلب وقتاً وخبرة، خصوصاً عند إنشاء إطار اختبار شامل.
- **استهلاك الموارد**: عملية الاختبار الآلي قد تكون مكلفة من حيث الموارد، وقد لا تكون مبررة للمشاريع الصغيرة أو الفرق الصغيرة.
- **المرونة المحدودة**: الاختبارات الآلية أقل مرونة من الاختبارات اليدوية، فهي تتبع تعليمات محددة مسبقاً وقد تفوّت بعض المشاكل غير المتوقعة التي قد يكتشفها المختبر البشري.
- **ملاءمة أقل للاختبارات الاستكشافية**: الاختبارات الآلية قد لا تكون الأنسب لحالات الاختبار الاستكشافية أو العشوائية.
- **الصيانة المستمرة**: الاختبارات الآلية تتطلب صيانة دورية لمواكبة التغييرات في البرنامج. إذا تغير التطبيق بشكل كبير، قد تحتاج الاختبارات إلى إعادة كتابة أو تعديل، ما قد يكون مستهلكاً للوقت.
.
