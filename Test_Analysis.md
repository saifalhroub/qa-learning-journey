...
- **Test Analysis**
  ...
  ### الخلاصة :
  - ال Test Analysis هو راس الهرم هو الي بحدد شو ممكن نختبر وكل ناتج هو عبارة عن Test Scenario الي بيجي تحتها هي Test Conditions لحيث يتم اختبار السيناريو بعدة حالات الي بيجي تحتها Test Caseوهي طريقة تنفيذ كل شرط
